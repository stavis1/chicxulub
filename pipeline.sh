...
singularity run --fakeroot --containall --bind ./:/data/ -w --unsquash percolator.sif percolator -U --reset-algorithm --weights /data/$name.weights -m /data/$name.pout /data/$name.filtered.pin
mkdir $name.results
